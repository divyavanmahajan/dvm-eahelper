"""
Markdown help text explaining how to use dvm_eahelper.leanix as a Python library.
Printed by ``eahelper --help-library``.
"""

LIBRARY_HELP = """
# Using dvm-eahelper as a Python Library

The `dvm_eahelper.leanix.download` module can be imported directly into your own Python scripts
to download FactSheets and relationships without going through the CLI.

## Prerequisites

The **eahelper proxy must be running** before you call any of these functions:
...
from dvm_eahelper.leanix.download import _SAFE_BASE_FIELDS, _BASE_SUBSELECT
...
```python
from dvm_eahelper.leanix.download import list_factsheet_types
...
import io
import sys
from dvm_eahelper.leanix.download import write_csv, write_json, write_relations_csv
